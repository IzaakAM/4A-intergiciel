...
public class App {
	public static void main(String[] args) {
                System.out.println("LANCEMENT DU PROCUCER");
		runProducer();
                System.out.println("LANCEMENT DU CONSUMER");
		runConsumer();
	}
	...
	static void runConsumer() {
                ...
                Runtime.getRuntime().addShutdownHook(new Thread() 
                {
                    ...
                    public void run() {
                        ...
                        try {mainThread.join();} catch (InterruptedException e) {System.out.println(e.getMessage());}
                                        }
                });
